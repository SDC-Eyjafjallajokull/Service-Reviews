...
var gameNames = ['Madden20', 'Madden21', 'Pokemon Shield', 'Pokemon Sword'];
...
// fsp.writeFile("productsMongo.json", JSON.stringify(products))
//   .then(() => {
...
fsp.writeFile("productsMongo.json", data)
  .then(() => {
    console.log('Done writing.');
  })
  .catch((err) => {
...
// mongoimport --db reviews --collection products --drop --file "/Users/yimingchen/Documents/Coding/Hack Reactor/HRLA40/SDC-Service-Reviews/productsMongo.json" --jsonArray